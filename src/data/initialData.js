...
export const INITIAL_SETTINGS = {
  ...
  heroBadge: 'Official Executive Travel & Shuttle Partner',
  heroTitle: 'Pesan Tiket Travel Cepat, Pilih Kursi Sendiri Sesuai Kenyamanan Anda',
  heroDesc: 'Layanan antar jemput door-to-door dengan armada Innova, iNNOVA. Didukung pengemudi berpengalaman, tarif transparan, dan sistem reservasi real-time.',
  logoUrl: '/logo.png',
